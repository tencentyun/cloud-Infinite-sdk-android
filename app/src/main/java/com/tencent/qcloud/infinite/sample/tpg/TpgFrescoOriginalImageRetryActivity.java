 ...
 */
public class TpgFrescoOriginalImageRetryActivity extends BaseActivity {
...
//        String test = "https://mobile-ut-1253960454.cos.ap-guangzhou.myqcloud.com/ci_image_sdk/default01.jpg?imageMogr2/format/avif|imageMogr2/thumbnail/150x50|imageMogr2/quality/30";
    ...
    private void loadImg(){
        ...
        GenericDraweeHierarchy hierarchy = new GenericDraweeHierarchyBuilder(getResources())
                // 设置占位图片
                .setPlaceholderImage(R.drawable.arrow)
                // 设置错误图片
